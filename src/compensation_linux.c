...
static hermas2_compensation_result write_synchronized(
    void *context,
    const uint8_t *record,
    size_t record_size) {
    hermas2_compensation_file *file = context;
    size_t written = 0u;
...
static hermas2_compensation_result map_file(
    int descriptor,
    const uint8_t **bytes,
    size_t *byte_count) {
    struct stat status;
...
hermas2_compensation_result hermas2_compensation_file_find(
    ...
    hermas2_compensation_result result = hermas2_compensation_find(
